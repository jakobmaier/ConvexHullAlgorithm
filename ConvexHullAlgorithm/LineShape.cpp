...
float LineShape::getThickness() const { return m_thickness; }
...
unsigned int LineShape::getPointCount() const { return 4; }

sf::Vector2f LineShape::getPoint(unsigned int index) const {
