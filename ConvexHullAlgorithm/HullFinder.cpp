...
const bool USE_CUSTOM_ALGO_FIX = true;
//
//			 ___0__
//        __/      \__
//       /     x      \
//		4______________1
//
// If this pattern is generated, and on position x both points 2 and 3 are placed (exact same coordinates),
// Graham's scan fails. We provided a simple fix that recognises this situation and doesn't put (3) on the
// convex hull.
// This fix can be activated/deactivated with the given flag
